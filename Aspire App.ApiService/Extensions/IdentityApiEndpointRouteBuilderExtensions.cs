...
using Aspire_App.ApiService.Features.Auth.UserRegister;
...
public static class IdentityApiEndpointRouteBuilderExtensions
{
    ...
    private static ValidationProblem CreateValidationProblem(Dictionary<string, string[]> errorDictionary) {
