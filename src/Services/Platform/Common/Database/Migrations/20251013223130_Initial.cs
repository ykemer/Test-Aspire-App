    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentEnrollStates", x => x.EventId);
                });

            migrationBuilder.CreateTable(
                name: "StudentUnenrollStates",
                columns: table => new
                {
                    EventId = table.Column<Guid>(type: "uuid", nullable: false),
                    CorrelationId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentUnenrollStates", x => x.EventId);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentEnrollStates_CorrelationId",
                table: "StudentEnrollStates",
                column: "CorrelationId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentUnenrollStates_CorrelationId",
                table: "StudentUnenrollStates",
                column: "CorrelationId");
        }
