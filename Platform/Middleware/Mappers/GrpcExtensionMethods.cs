...
public static class GrpcExtensionMethods
{
    ...
    {
        return new PagedList<StudentResponse>
        {
    ...
    {
        return response.Items.Select(i => new EnrollmentResponse
        {
            Id = i.Id,
            CourseId = i.CourseId,
    ...
    public static List<CourseListItemResponse> ToCourseListItemResponse(this GrpcListCoursesResponse course, GrpcListEnrollmentsResponse withEnrollments)
    {
        return course.Items.Select(i => new CourseListItemResponse
        {
            Id = Guid.Parse(i.Id),
            Name = i.Name,
