...
public class CourseExtensionMethodsTest
{
  ...
  public void MapToGrpcCourseResponse_MapsCorrectly()
  {
    ...
    Assert.That(grpcResponse.Id, Is.EqualTo(course.Id.ToString()));
  ...
  public void MapToGrpcClassResponse_MapsCorrectly()
  {
    ...
    Assert.That(grpcResponse.Id, Is.EqualTo(courseClass.Id.ToString()));
    Assert.That(grpcResponse.CourseId, Is.EqualTo(courseClass.CourseId.ToString()));
